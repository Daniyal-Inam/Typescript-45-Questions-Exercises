...
//on it. Call the function.T-Shirt: Write a function called make_shirt() that
...
make_shirt("small", "Hello World, I love coding");
make_shirt("medium", "Hello World, I love coding");
make_shirt("large", "Hello World, I love coding");